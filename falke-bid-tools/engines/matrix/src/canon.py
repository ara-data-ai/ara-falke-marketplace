...
Firm-specific quirks (the Robmar-style reclassifications) live in
...
# old PBS_SPLIT_ROUTING constant AND the inline literals that lived in
...
# ROBMAR_RECLASSIFICATIONS) now live in config/known_firms.yaml and are loaded by
# firm_config.py — no firm names in engine source (Marvin §4, Floyd C4/M4).
