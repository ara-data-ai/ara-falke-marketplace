...
from .scoring import CATEGORY_ORDER, apply_overrides, build_bidder_scores
...
def run_scorecard(
    ...
    *,
    ...
    for m in mech:
        ...
        # qualitative scaffold (mechanical seeds + degradation)
        ...
        wa = scores.weighted_average_x10(cfg.weights)
        ...
        bidder = {
            ...
            "scores": {k: scores.categories[k].effective_score for k in CATEGORY_ORDER},
        ...
        rank_input.append({
            ...
            "pricing_score": scores.categories["pricing"].effective_score,
