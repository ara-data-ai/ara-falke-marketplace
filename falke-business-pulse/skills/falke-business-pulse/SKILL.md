...
Render this content into Anna's Falke-branded one-pager,
...
- It does no Falke **visual/brand design** (Anna, next) and does not finalize
  doc/guide polish (Maggie).

## Reference files

- `reference/digest-template.html` — Anna's Falke-branded one-page pulse template
